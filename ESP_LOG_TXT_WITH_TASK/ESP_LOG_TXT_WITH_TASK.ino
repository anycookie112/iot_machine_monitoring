...
void setup() {
    ...
    xTaskCreatePinnedToCore(updateMachineState, "LogWriter", 4096, NULL, 1, NULL, 1);
...
void updateMachineState(void *pvParameters) {
    ...
    for (;;) {
        ...
        vTaskDelay(1000 / portTICK_PERIOD_MS);  // Check every 3s
    }
