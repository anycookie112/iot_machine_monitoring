...
const char* mqtt_server = "192.168.1.15"; // Host machine IP
...
void loop() {
    checkWiFiReconnect();  // Ensure WiFi is connected
    checkMQTTReconnect();  // Ensure MQTT is connected
    mqttClient.loop();  // Process MQTT messages

    int pinState = digitalRead(pin5);  // Read pin 5 state
